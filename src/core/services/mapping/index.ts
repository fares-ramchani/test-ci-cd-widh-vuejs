...
export class HttpClient<SecurityDataType = unknown> {
  ...
  public request = async <T = any, E = any>({
    ...
    try {
      ...
      if (!resp.ok) {
        if (data?.error?.statusCode === 401 || data?.statusCode === 401)
          this.handleError?.();
...
> extends HttpClient<SecurityDataType> {
  ...
  users = {
     ...
     * @request POST:/users
     */
    userControllerCreateUser: (params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/users`,
        method: "POST",
        ...params,
     ...
     */
    userControllerGetUser: (id: number, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/users/${id}`,
        method: "GET",
        ...params,
     ...
     */
    userControllerUpdateUser: (id: number, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/users/${id}`,
        method: "PATCH",
        ...params,
